    ...
    <main>
      ...
      <div className="relative">
        <div className="sticky top-0 -z-10 h-full w-full bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]">
          <div id="cornerEffect" className="absolute top-0 left-0 -z-10 h-[310px] w-[310px] rounded-full bg-fuchsia-400 opacity-20 blur-[100px] transition-all duration-500 ease-in-out"></div>
        </div>
        <CreatorSection />
        <ArtistSection />
        <LabelSection />
